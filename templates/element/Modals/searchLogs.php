...
<div class="modal fade modal-right" id="searchLogs_mdl" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-12">
                            <form method="post" novalidate="novalidate" id="searchLogs_form" class="row" 
                            ng-submit=" rec.search.page = 1; doSearch(); ">
                                ...
                                <div id="ssearchLogs_sec" class="collapse show col-12" data-parent="#searchLogs_form">
                                    <div class="row">
