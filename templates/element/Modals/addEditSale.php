        ...
        <div class="modal-content">
            ...
            <form class="row" id="client_form" ng-show="showAddClientForm" ng-submit="
                ...
                <div class="col-md-6 col-sm-6 form-group has-feedback">
                    ...
                    <div class="div">
                        <tags-input ng-model="rec.client.country" add-from-autocomplete-only="true" max-tags="1"
                            placeholder="<?= __('country') ?>" display-property="text" key-property="value">
                            <auto-complete min-length="1" highlightMatchedText="true"
                                source="loadTags($query, 'countries')"></auto-complete>
                        </tags-input>
                ...
                <div class="col-md-6 col-sm-6 form-group has-feedback">
                    ...
                    <div class="div">
                        <tags-input ng-model="rec.client.city" add-from-autocomplete-only="true"
                            placeholder="<?= __('city') ?>" display-property="text" key-property="value">
                            <auto-complete min-length="1" highlightMatchedText="true"
                                source="loadTags($query, 'cities')"></auto-complete>
                        </tags-input>
                ...
                <div class="col-md-6 col-sm-6 form-group has-feedback">
                    ...
                    <div class="div">
                        <tags-input ng-model="rec.client.region" add-from-autocomplete-only="true"
                            placeholder="<?= __('region') ?>" display-property="text" key-property="value">
                            <auto-complete min-length="1" highlightMatchedText="true"
                                source="loadTags($query, 'regions')"></auto-complete>
                        </tags-input>
                ...
                <div class="col-md-12 col-sm-12 form-group has-feedback">
                    <button type="submit" class="btn btn-info" ng-click="toggleAddClientForm()"
                        id="client_preloader"><span></span>
