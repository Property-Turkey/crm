...
<div class="paginator" style="z-index: 0;">
...
<?php }else{ ?>
<div class="paginator"style="z-index: 0;">
    <div  ng-if="paging.count > paging.perPage" class="" style="display: flex;justify-content: space-between;">
        <span class="" ng-class="{disabled: paging.page<2}"> <a href="javascript:void(0);" class="page-link"
