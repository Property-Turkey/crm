                ...
                $scope.inlineElement = function (tar, stat, element) {
                    ...
                    `)($scope);
                        ...
                        `)($scope);
                            ...
                            //                             load-on-focus="true"
                            //                             load-on-empty="true"
                            //                             max-results-to-show="30"  source="loadTags($query, 'users', '', 'admin.callcenter,admin.portfolio')"></auto-complete>
                            //                 </tags-input>
                            //             </label>
                                ...
                                <label for="" class="col-6 col-sm-12">
                                    ...
                                    >
                                        <auto-complete min-length="0"
                                                load-on-focus="true"
                                                load-on-empty="true"
                                                max-results-to-show="30"  source="loadTags($query, 'users', '', 'admin.callcenter,admin.portfolio,admin.teamleader')"></auto-complete>
                                    </tags-input>
                                </label>
        ...
        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#clientAccordion">
            <div class="accordion-body">
                <div class="row" ng-repeat="(recStateId, recStateName) in rec.client.user_client track by (recStateName.id + recStateName.user.user_fullname)">
                    ...
                    <form class="row col-6 inlineElement" ng-if="recStateName.rec_state == 2" ng-submit="
                        rec.user_client.client_id = recStateName.client_id;
                    ...
                    <form class="row col-6 inlineElement" ng-if="recStateName.rec_state == 2" id="client_form" ng-submit="
                    ...
                    `)
                            ...
                            <form class="row  inlineElement"  id="client_form" ng-submit="
                                ...
                                <?php if (!(in_array($authUser['user_role'], ['admin.accountant'])) || isset($authUser['user_original_role'])) { ?>
                                                    ...
                                                    <label class="col-md-6 col-12 col-lg-3">
                                                        ...
                                                        <?= $this->Form->control('unit_info', [
                                                            'class' => 'wb-ele-select-modal col-12 p-2',
                                                            'label' => false,
                                                            'type' => 'textarea',
                    ...
                    `)
                            ...
                            <form class="row  inlineElement"  id="client_form" ng-submit="
                                ...
                                <?php if (!in_array($authUser['user_role'], ['admin.accountant', 'admin.portfolio']) || isset($authUser['user_original_role'])) { ?>
                                                ...
                                                <label class="col-md-6 col-12 col-lg-3" style="position: relative;">
                                                    <span class="sm-txt"> <?= __('clientspec_target_country') ?> </span>

                                                    <tags-input  style="padding: 0px;padding-left: 10px;"
                                                        class="wb-txt-inp" 
                                                        tag-class="{even: $index % 2 == 0, odd: $index % 2 != 0}"
                                                        ng-model="rec.client.client_specs[0].clientspec_target_country" 
                                                        add-from-autocomplete-only="true" 
                                                        max-tags="1" 
                                                        placeholder="<?= __('clientspec_target_country') ?>" 
                                                        display-property="text"
                                                        key-property="value"
                                                        ng-disabled="rec.client.client_specs[0].targetCountry"
                                                        ng-style="{'background-color': rec.client.client_specs[0].targetCountry ? '#eeeeee' : 'initial'}"
                                                    ...
                                                    <span ng-if="rec.client.client_specs[0].targetCountry" ng-click="rec.client.client_specs[0].targetCountry = '';" class="fa fa-times" style="cursor: pointer; position: absolute; top: 55%; right: 20px; transform: translateY(-50%);"></span>                                        

                                                </label>
                                                <label class="col-md-6 col-12 col-lg-3" style="position: relative;">
                                                    <span class="sm-txt"> <?= __('clientspec_target_city') ?> </span>

                                                    <tags-input  style="padding: 0px;padding-left: 10px;"
                                                        class="wb-txt-inp" 
                                                        tag-class="{even: $index % 2 == 0, odd: $index % 2 != 0}"
                                                        ng-model="rec.client.client_specs[0].clientspec_target_city" 
                                                        add-from-autocomplete-only="true" 
                                                        max-tags="1" 
                                                        placeholder="<?= __('clientspec_target_city') ?>" 
                                                        display-property="text"
                                                        key-property="value"
                                                        ng-disabled="rec.client.client_specs[0].targetCity"
                                                        ng-style="{'background-color': rec.client.client_specs[0].targetCity ? '#eeeeee' : 'initial'}"
                                                    ...
                                                    <span ng-if="rec.client.client_specs[0].targetCity" ng-click="rec.client.client_specs[0].targetCity = '';" class="fa fa-times" style="cursor: pointer; position: absolute; top: 55%; right: 20px; transform: translateY(-50%);"></span>                                        

                                                </label>
                                            
                                                 <label class="col-md-6 col-12 col-lg-3" style="position: relative;">
                                                    <span class="sm-txt"> <?= __('clientspec_target_region') ?> </span>

                                                    <tags-input  style="padding: 0px;padding-left: 10px;"
                                                        class="wb-txt-inp" 
                                                        tag-class="{even: $index % 2 == 0, odd: $index % 2 != 0}"
                                                        ng-model="rec.client.client_specs[0].clientspec_target_region" 
                                                        add-from-autocomplete-only="true" 
                                                        max-tags="1" 
                                                        placeholder="<?= __('clientspec_target_region') ?>" 
                                                        display-property="text"
                                                        key-property="value"
                                                        ng-disabled="rec.client.client_specs[0].targetRegion"
                                                        ng-style="{'background-color': rec.client.client_specs[0].targetRegion ? '#eeeeee' : 'initial'}"
                                                    ...
                                                    <span ng-if="rec.client.client_specs[0].targetRegion" ng-click="rec.client.client_specs[0].targetRegion = '';" class="fa fa-times" style="cursor: pointer; position: absolute; top: 55%; right: 20px; transform: translateY(-50%);"></span>                                        
                                ...
                                <label for="" class="col-6 col-sm-12">
                                    ...
                                    >
                                        <auto-complete min-length="0"
                                                load-on-focus="true"
                                                load-on-empty="true"
                                                max-results-to-show="30"  source="loadTags($query, 'users', '', 'admin.portfolio')"></auto-complete>
                                    </tags-input>
                                </label>
                                ...
                                <label for="" class="col-6 col-sm-12">
                                    ...
                                    >
                                        <auto-complete min-length="0"
                                                load-on-focus="true"
                                                load-on-empty="true"
                                                max-results-to-show="30"  source="loadTags($query, 'users', '', 'admin.callcenter,admin.teamleader')"></auto-complete>
                                    </tags-input>
                                </label>
